...
async function convToBacklogMd(doc) {
  ...
  // }
  // { type: 'definition',
  //   identifier: 'kanye_west_lollapalooza_chile_2011_2.jpg',
  //   label: 'kanye_west_lollapalooza_chile_2011_2.jpg',
  //   title: null,
  //   url: 'aaaaaaaaaaaaaaaa.jpg',
  // }
  images.forEach(node => {
    try {
...
function convToNormalMd(content, attachments) {
